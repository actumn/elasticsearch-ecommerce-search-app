var app = new Vue({
    ...
    methods: {
      reindex : function() {
        ...
        axios
          .post("http://localhost:4000/admin/index_data?numberOfProducts=" + this.numberOfProducts)
      ...
      configure_synonyms: function() {
        ...
        axios
          .post("http://localhost:4000/admin/configure_synonyms", {synonyms: this.synonyms})
          .then(response => {
